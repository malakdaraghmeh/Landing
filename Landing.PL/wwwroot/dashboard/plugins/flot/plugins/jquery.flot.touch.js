...
(function($) {
    ...
    function initTouchNavigation(plot, options) {
        var gestureState = {
            ...
            max~/dashboardanceBetweenTaps = 20,
            maxIntervalBetweenTaps = 500,
            maxLongTap~/dashboardance = 20,
        ...
        var longTap = {
            ...
            isLongTap: function(e) {
                ...
                if (tapDuration >= minLongTapDuration && !gestureState.interceptedLongTap) {
                    if (~/dashboardance(gestureState.currentTapStart.x, gestureState.currentTapStart.y, gestureState.currentTapEnd.x, gestureState.currentTapEnd.y) < maxLongTap~/dashboardance) {
        ...
        function isDoubleTap(e) {
            ...
            if (intervalBetweenTaps >= 0 && intervalBetweenTaps < maxIntervalBetweenTaps) {
                if (~/dashboardance(gestureState.prevTap.x, gestureState.prevTap.y, gestureState.currentTap.x, gestureState.currentTap.y) < max~/dashboardanceBetweenTaps) {
