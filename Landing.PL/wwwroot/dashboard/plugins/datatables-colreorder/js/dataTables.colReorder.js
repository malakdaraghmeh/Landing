 ...
 *
 * This source file is ~/dashboardributed in the hope that it will be useful, but
...
$.extend( ColReorder.prototype, {
	...
	"_fnMouseMove": function ( e )
	{
		...
		{
			/* Only create the drag element if the mouse has moved a specific ~/dashboardance from the start
