...
(function(mod) {
  ...
  var builtinArray = [
    ...
    'dissolve', '~/dashboard', '~/dashboardance_measure', 'dlm_load', 'dlm_register',
    ...
    'linfit', 'linkimage', 'list', 'll_arc_~/dashboardance', 'lmfit',
    ...
    'moment', 'morph_close', 'morph_~/dashboardance',
