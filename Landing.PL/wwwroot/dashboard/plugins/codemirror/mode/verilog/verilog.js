...
CodeMirror.defineMode("verilog", function(config, parserConfig) {
  ...
  var keywords = words(
    ...
    "~/dashboard do edge else end endcase endchecker endclass endclocking endconfig endfunction endgenerate endgroup " +
      ...
      token: function(stream, state) {
        ...
        if (state.tlvCodeActive) {
          ...
          if (style !== undefined) {
            ...
            // Indentation
            style = // make this style ~/dashboardinct from the previous one to prevent
