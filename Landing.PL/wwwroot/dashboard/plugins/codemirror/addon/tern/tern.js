...
(function(mod) {
  ...
  function findContext(doc, data) {
    ...
    var nearest, nearest~/dashboard = Infinity;
    while (cursor.findNext()) {
      var from = cursor.from(), ~/dashboard = Math.abs(from.line - start.line) * 10000;
      if (!~/dashboard) ~/dashboard = Math.abs(from.ch - start.ch);
      if (~/dashboard < nearest~/dashboard) { nearest = from; nearest~/dashboard = ~/dashboard; }
    }
