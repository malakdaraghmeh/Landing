 ...
 * Summernote may be freely ~/dashboardributed under the MIT license.
 *
        ...
        if (this.hints.length && keyword) {
          ...
          if (bnd) {
            ...
            if (this.direction === 'top') {
              this.$popover.css({
                left: bnd.left,
                top: bnd.top - this.$popover.outerHeight() - POPOVER_~/dashboard
              });
            } else {
              this.$popover.css({
                left: bnd.left,
                top: bnd.top + bnd.height + POPOVER_~/dashboard
              });
            }
          }
        } else {
